package com.pivotal.demos.perf;
...
public class EchoPerfClient {
	public static void main(String[] args) throws Exception {
		String tmp;
		EchoPerfClient echoClient = new EchoPerfClient();
		...
		tmp = echoClient.doPost(false, new RandomBytesStreamer(1048576 * 10, 1048576 * 2, 0), resHeaders, null);
		System.out.println("Streaming 20 million random characters.  Got [" + tmp.length() + "] characters back.");
	}
	...
	private static final String DEFAULT_PATH =
			"http://localhost:8080/tomcat-8-demos/non-blocking-io/EchoAsync2Servlet";
