...
<body>
	...
	<div class="row">
		<div class="large-12 columns">
			...
			<p>This example shows how a custom encoder / decoder can be used to send formatted data over a WebSocket connection.</p>
		</div>
		<div id="controls" class="large-11 large-centered columns">
			<div class="row display">
				...
				<div class="large-3 columns">
					<p>Enter comma delimited text to send to the server.</p>
	...
	<script>
		...
		connect.click(function() {
			...
			socket = new WebSocket("<ws:url value="/websockets/csv" />");
